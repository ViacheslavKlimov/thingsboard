...
@Slf4j
public class RuleChain extends SearchTextBasedWithAdditionalInfo<RuleChainId> implements HasName, HasTenantId, ExportableEntity<RuleChainId, RuleChain> {
    ...
    @Override
    public RuleChain updateEntityData(RuleChain ruleChain) {
        return null;
    }
