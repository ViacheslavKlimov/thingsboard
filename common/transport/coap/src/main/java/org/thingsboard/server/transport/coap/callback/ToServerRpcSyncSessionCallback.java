...
public class ToServerRpcSyncSessionCallback extends AbstractSyncSessionCallback {
    ...
    public ToServerRpcSyncSessionCallback(CoapTransportContext context, TbCoapClientState state, CoapExchange exchange, Request request, TransportProtos.SessionInfoProto sessionInfo) {
