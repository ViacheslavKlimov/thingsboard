...
export class TcpDeviceProfileTransportConfigurationComponent implements ControlValueAccessor, OnInit {

  tcpDeviceProfileTransportConfigurationFormGroup: FormGroup;
  ...
  ngOnInit() {
    ...
    this.tcpDeviceProfileTransportConfigurationFormGroup.valueChanges.subscribe(() => {
      this.updateModel();
    });
  }
  ...
  writeValue(value: UdpDeviceProfileTransportConfiguration | null): void {
    this.tcpDeviceProfileTransportConfigurationFormGroup.patchValue({configuration: value}, {emitEvent: false});
  }

  private updateModel() {
    let configuration: DeviceProfileTransportConfiguration = null;
    if (this.tcpDeviceProfileTransportConfigurationFormGroup.valid) {
      configuration = this.tcpDeviceProfileTransportConfigurationFormGroup.getRawValue().configuration;
