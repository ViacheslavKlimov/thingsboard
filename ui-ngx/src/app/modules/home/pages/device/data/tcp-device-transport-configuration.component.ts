...
import {
  ...
  DeviceTransportType, TcpDeviceTransportConfiguration
...
export class TcpDeviceTransportConfigurationComponent implements ControlValueAccessor, OnInit {

  tcpDeviceTransportConfigurationFormGroup: FormGroup;
  ...
  ngOnInit() {
    ...
    this.tcpDeviceTransportConfigurationFormGroup.valueChanges.subscribe(() => {
      this.updateModel();
    });
  }
  ...
  writeValue(value: TcpDeviceTransportConfiguration | null): void {
    this.tcpDeviceTransportConfigurationFormGroup.patchValue({configuration: value}, {emitEvent: false});
  }

  private updateModel() {
    let configuration: DeviceTransportConfiguration = null;
    if (this.tcpDeviceTransportConfigurationFormGroup.valid) {
      configuration = this.tcpDeviceTransportConfigurationFormGroup.getRawValue().configuration;
      configuration.type = DeviceTransportType.TCP;
    }
